// cc/testmmerge.cc rev. 22 July 2013 by Stuart Ambler.  Tests cc/mmerge.cc.
...
// The C++ version for the priority queue method is less than half as fast as
// the C version, and for the linear method, less than one sixth.
